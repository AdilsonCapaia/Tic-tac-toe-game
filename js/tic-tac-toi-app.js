...
!function($){
	...
	function Board(){
		...
		this.board = function(){
			...
			$ulPlayers.append($playerO);
			$ulPlayers.append($playerX);
			// append the elements to the header
			$header.append($h1);
			$header.append($ulPlayers);
			
			var $ulBoard=$("<ul>");
			$ulBoard.addClass("boxes");
			for(var i=0; i<9 ; i++){
